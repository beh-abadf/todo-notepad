            ...
            <div class="center">
                ...
                <form id="advanced_textarea" method="POST" action="../store-a-note">
                    ...
                    <div id="txt_ar_options" class="flex">
                        ...
                        <select name="" id="font_family_selector" class="form-control" style="margin-left: 4px;">
                        ...
                        <select name="" id="font_size_selector" class="form-control" style="margin-left: 4px;">
                            <option disabled selected>
                                {{ __('stuffs.font_size') }}
                            </option>
                            <option value="12px">
                    ...
                    <div id="txt_ar_main">
                        <textarea name="note_text" id="note_text" placeholder="{{ __('stuffs.write_here') }}" cols="30" rows="10"
                            autofocus class="form-control">{{ old('note_text') }}</textarea>
